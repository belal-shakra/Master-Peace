                      ...
                      (function () {
                          ...
                          function f(t) {
                              ...
                              return (
                                  ...
                                  s.some(function (e) {
                                      var s, i;
                                      return (
                                          "function" == typeof (null === (i = null === (s = null == t ? void 0 : t.ownerDocument) || void 0 === s ? void 0 : s.defaultView) || void 0 === i ? void 0 : i[e]) &&
                          ...
                          function m(t, e, s) {
                              ...
                              return (
                                  "#text" === t.nodeName
                                      ...
                                      : (e
                                            ? ((i = s.document.createElementNS("http://www.w3.org/2000/svg", t.nodeName)), "foreignObject" === t.nodeName && (e = !1))
                                        ...
                                        s.valueDiffing &&
                                            (t.value &&
                                                f(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") &&
                                                (i.value = t.value),
                                            t.checked && f(i, "HTMLInputElement") && (i.checked = t.checked),
                                            t.selected && f(i, "HTMLOptionElement") && (i.selected = t.selected))),
                                  i
                              );
                          }
                          var g = function (t, e) {
                          ...
                          function b(t, e, s) {
                              ...
                              switch (o) {
                                  ...
                                  case s._const.relocateGroup:
                                      u([], new Array(e[s._const.groupLength]), !0)
                                          .map(function () {
                          ...
                          var w = function (t) {
                              ...
                              N = function (t) {
                                  ...
                                  return (
                                      Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = h({}, t.attributes)),
                                          ...
                                          switch (e[s._const.action]) {
                                              case s._const.addAttribute:
                                                  n.attributes || (n.attributes = {}),
                                                      ...
                                                      "checked" === e[s._const.name]
                                                          ...
                                                          ? (n.selected = !0)
                                                          : "INPUT" === n.nodeName && "value" === e[s._const.name] && (n.value = e[s._const.value]);
                                                  break;
                                              case s._const.modifyAttribute:
                                                              ...
                                                              if (e[s._const.from] < e[s._const.to] && t.oldValue <= e[s._const.to] && t.oldValue > e[s._const.from])
                                                                  (t.oldValue -= e[s._const.groupLength]),
                                                                      (i = t.oldValue + t.length - e[s._const.to]) > 0 &&
                                                                          (c.push({ oldValue: e[s._const.to] + e[s._const.groupLength], newValue: t.newValue + t.length - i, length: i }), (t.length -= i));
                                                              ...
                                                              t.oldValue > o
                                                                  ...
                                                                  : t.oldValue < o &&
                                                                    ...
                                                                    (t.oldValue + t.length - 1 === o
                                                                        ? t.length--
                                                                        : (c.push({ newValue: t.newValue + o - t.oldValue, oldValue: o, length: t.length - o + t.oldValue - 1 }), (t.length = o - t.oldValue)));
                                                          }),
                                                      (n = a);
                                                  break;
                                              case s._const.addElement:
                                                  var u = (d = e[s._const.route].slice()).splice(d.length - 1, 1)[0];
                                                  (n = null === (i = C(t, d)) || void 0 === i ? void 0 : i.node),
                                              ...
                                              case s._const.addTextElement:
                                                  ...
                                                  (l = { nodeName: "#text", data: e[s._const.value] }),
                                                      (n = C(t, d).node).childNodes || (n.childNodes = []),
                          ...
                          function k(t, e) {
                              ...
                              if (f(t, "Text", "Comment")) s.data = t.data;
                                  ...
                                  e.valueDiffing &&
                                      (f(t, "HTMLTextAreaElement") && (s.value = t.value),
                                      f(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked
                                          ? (s.checked = t.checked)
                                          : f(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value),
                                      f(t, "HTMLOptionElement") && (s.selected = t.selected));
                              }
                              return s;
                          }
                          ...
                          var P = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, menuItem: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 },
                              R = function (t, e) {
                                  ...
                                  if (n && ((s.nodeName = e || "svg" === n[1] ? n[1] : n[1].toUpperCase()), (P[n[1]] || "/" === t.charAt(t.length - 2)) && (i = !0), s.nodeName.startsWith("!--"))) {
                                      var a = t.indexOf("--\x3e");
                                      return { type: "comment", node: { nodeName: "#comment", data: -1 !== a ? t.slice(4, a) : "" }, voidElement: i };
                                  }
                                      ...
                                      t.replace(T, function (r, l) {
                                          ...
                                          if (d) {
                                              if (("svg" === (s = R(r, e.caseSensitive || o)).node.nodeName && (o = !0), n++, !s.voidElement && u && "<" !== u)) {
                                                  ...
                                                  s.node.childNodes.push({ nodeName: "#text", data: m }), e.valueDiffing && "TEXTAREA" === s.node.nodeName && (s.node.value = m);
                                              }
                                          ...
                                          if (
                                              (!d || s.voidElement) &&
                                              (n > -1 &&
                                                  (s.voidElement || (e.caseSensitive && s.node.nodeName === r.slice(2, -1)) || (!e.caseSensitive && s.node.nodeName.toUpperCase() === r.slice(2, -1).toUpperCase())) &&
                                                  --n > -1 &&
                              ...
                              I = (function () {
                                  function t(t, e, s) {
                                      (this.options = s),
                                          (this.t1 = "undefined" != typeof Element && f(t, "Element") ? k(t, this.options) : "string" == typeof t ? H(t, this.options) : JSON.parse(JSON.stringify(t))),
                                          (this.t2 = "undefined" != typeof Element && f(e, "Element") ? k(e, this.options) : "string" == typeof e ? H(e, this.options) : JSON.parse(JSON.stringify(e))),
                                          (this.diffcount = 0),
                                          (this.foundAll = !1),
                                          this.debug &&
                                              ((this.t1Orig = "undefined" != typeof Element && f(t, "Element") ? k(t, this.options) : "string" == typeof t ? H(t, this.options) : JSON.parse(JSON.stringify(t))),
                                              (this.t2Orig = "undefined" != typeof Element && f(e, "Element") ? k(e, this.options) : "string" == typeof e ? H(e, this.options) : JSON.parse(JSON.stringify(e)))),
                                          (this.tracker = new $());
                                  }
                                  return (
                                      ...
                                      (t.prototype.findDiffs = function (t, e) {
                                          ...
                                          do {
                                              ...
                                              0 === (s = this.findNextDiff(t, e, [])).length &&
                                                  (x(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : ((this.foundAll = !0), M(t), (s = this.findNextDiff(t, e, []))))),
                                                  s.length > 0 && ((this.foundAll = !1), this.tracker.add(s), S(t, s, this.options));
                                          } while (s.length > 0);
                                                  ...
                                                  (u && !f
                                                      ? "#text" === u.nodeName
                                                          ? (r.push(
                                                            ...
                                                            (l -= 1))
                                                          : (r.push(
                                                                new p().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, N(u))
                                                            ),
                                                            (l -= 1))
                                                      : f &&
                                                        !u &&
                                                        ("#text" === f.nodeName
                                                            ...
                                                            : r.push(
                                                                  new p().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, N(f))
                                                              ))),
                                                  u &&
                                                      f &&
                                                      (!this.options.maxChildCount || a < this.options.maxChildCount
                                                          ? (r = r.concat(this.findNextDiff(u, f, s.concat(l))))
                                                          : x(u, f) ||
                                                            (i.length > n.length
                                                                ? ("#text" === u.nodeName
                                                                      ? r.push(
                                                                      ...
                                                                      : r.push(
                                                                            new p()
                                                                                ...
                                                                                .setValue(this.options._const.element, N(u))
                                                                                .setValue(this.options._const.route, s.concat(l))
                                                                        ),
                                                                  i.splice(h, 1),
                                                                  (h -= 1),
                                                                ...
                                                                ? ((r = r.concat([
                                                                      new p()
                                                                          ...
                                                                          .setValue(this.options._const.element, N(f))
                                                                          .setValue(this.options._const.route, s.concat(l)),
                                                                  ])),
                                                                  i.splice(h, 0, N(f)),
                                                                  (o -= 1))
                                                                : (r = r.concat([
                                                                      new p()
                                                                          .setValue(this.options._const.action, this.options._const.replaceElement)
                                                                          .setValue(this.options._const.oldValue, N(u))
                                                                          .setValue(this.options._const.newValue, N(f))
                                                                          .setValue(this.options._const.route, s.concat(l)),
                                                                  ])))),
                                                  (l += 1);
                                          }
                                          ...
                                          for (
                                              ...
                                              if (!n || (!0 !== h[v] && !0 !== u[v])) {
                                                  if (!0 === h[_])
                                                      if ("#text" === (l = f[_]).nodeName)
                                                              ...
                                                              if (l.data !== m[v].data) {
                                                                  ...
                                                                  d ||
                                                                      b.push(
                                                                          new p()
                                                                              .setValue(this.options._const.action, this.options._const.modifyTextElement)
                                                                              .setValue(this.options._const.route, i.concat(_))
                                                                              .setValue(this.options._const.oldValue, l.data)
                                                                              .setValue(this.options._const.newValue, m[v].data)
                                                                      );
                                                              }
                                                          } else
                                                              b.push(
                                                          ...
                                                          !0 === u[v]
                                                              ? b.push(
                                                                    new p()
                                                                        .setValue(this.options._const.action, this.options._const.replaceElement)
                                                                        .setValue(this.options._const.oldValue, N(l))
                                                                        .setValue(this.options._const.newValue, N(m[v]))
                                                                        .setValue(this.options._const.route, i.concat(_))
                                                                )
                                                              : (b.push(
                                                                    new p()
                                                                        .setValue(this.options._const.action, this.options._const.removeElement)
                                                                        .setValue(this.options._const.route, i.concat(_))
                                                                        .setValue(this.options._const.element, N(l))
                                                                ),
                                                                h.splice(_, 1),
                                                                f.splice(_, 1),
                                                                (g = Math.min(h.length, u.length)),
                                                      ...
                                                      "#text" === (l = m[v]).nodeName
                                                          ? (b.push(
                                                                new p().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)
                                                            ),
                                                            h.splice(_, 0, !0),
                                                            f.splice(_, 0, { nodeName: "#text", data: l.data }),
                                                            (g = Math.min(h.length, u.length)))
                                                          : (b.push(
                                                                new p().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, N(l))
                                                            ),
                                                            h.splice(_, 0, !0),
                                                            f.splice(_, 0, N(l)),
                                                            (g = Math.min(h.length, u.length)));
                          ...
                          const F = (t, e, s, { classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l }, { noColumnWidths: d, unhideHeader: h }) => ({
                                  nodeName: "TR",
                                  childNodes: t
                                      .map((t, u) => {
                                          ...
                                          if (
                                              (p.sortable && o && (!r.length || h) && (p.filter ? (f["data-filterable"] = "true") : (f["data-sortable"] = "true")),
                                          ...
                                          return {
                                              nodeName: "TH",
                                              attributes: f,
                                              childNodes: (!a && !r.length) || h ? (p.sortable && o ? [{ nodeName: "BUTTON", attributes: { class: p.filter ? i.filter : i.sorter }, childNodes: m }] : m) : [{ nodeName: "#text", data: "" }],
                                          };
                                      })
                                      .filter((t) => t),
                              }),
                              q = (
                                  ...
                                  a,
                                  o,
                                  { classes: r, hiddenHeader: l, header: d, footer: h, format: u, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b },
                                                  ...
                                                  const s = {
                                                      ...
                                                      childNodes: t.cells
                                                          .map((t, s) => {
                                                              ...
                                                              if (o.hidden) return;
                                                              const r = { nodeName: "TD", attributes: t.attributes ? { ...t.attributes } : {}, childNodes: "html" === o.type ? t.data : [{ nodeName: "#text", data: n(t) }] };
                                                              if (
                                                                  (d || h || !a.widths[s] || v || (r.attributes.style = c(r.attributes.style, `width: ${a.widths[s]}%;`)),
                                                                  o.cellClass && (r.attributes.class = c(r.attributes.class, o.cellClass)),
                                                                  o.render)
                                                              ) {
                                  ...
                                  if (((M.attributes.class = c(M.attributes.class, r.table)), d || h || w)) {
                                      const t = F(e, i, a, { classes: r, hiddenHeader: l, sortable: p, scrollY: f }, { noColumnWidths: v, unhideHeader: _ });
                                      if (d || w) {
                                          const e = { nodeName: "THEAD", childNodes: [t] };
                                          (!f.length && !l) || _ || (e.attributes = { style: "height: 0px;" }), M.childNodes.unshift(e);
                                      }
                                      if (h) {
                                          const e = { nodeName: "TFOOT", childNodes: [d ? structuredClone(t) : t] };
                                          (!f.length && !l) || _ || (e.attributes = { style: "height: 0px;" }), M.childNodes.push(e);
                                      }
                                  }
                              ...
                              X = (t, e) => {
                                  ...
                                  switch (e.type) {
                                      ...
                                      case "number":
                                          ...
                                          break;
                                      case "html": {
                                          const t = Array.isArray(s.data) ? { nodeName: "TD", childNodes: s.data } : H(`<td>${String(s.data)}</td>`);
                                          s.data = t.childNodes || [];
                                          const e = i(t);
                                          (s.text = e), (s.order = e);
                                          break;
                                  ...
                                  if (t.headings) o.headings = t.headings.map((t) => Z(t));
                                      ...
                                      o.headings = Array.from(e.tHead.querySelectorAll("th")).map((t, e) => {
                                          const o = ((t) => {
                                              ...
                                              let s;
                                              return (
                                                  (s = !e.childNodes || (1 === e.childNodes.length && "#text" === e.childNodes[0].nodeName) ? { data: t.innerText, type: "string" } : { data: e.childNodes, type: "html", text: i(e) }),
                                  ...
                                  if (t.data) {
                                      ...
                                      o.data = t.data.map((t) => {
                                          ...
                                          return (
                                              Array.isArray(t)
                                                  ? ((i = {}), (n = t))
                                                  : t.hasOwnProperty("cells") && Object.keys(t).every((t) => ["cells", "attributes"].includes(t))
                                                  ...
                                                  const i = t.dataset.content
                                                      ...
                                                      : ((t, e) => {
                                                            ...
                                                            switch (e.type) {
                                                                ...
                                                                default:
                                                                    s = { data: k(t, { valueDiffing: !1 }).childNodes || [], text: t.innerText, order: t.innerText };
                                                            }
                          ...
                          class tt {
                                      ...
                                      return (
                                          t.forEach((t) => {
                                              (Array.isArray(t.select) ? t.select : [t.select]).forEach((o) => {
                                                  i[o] ? t.type && (i[o].type = t.type) : (i[o] = { type: t.type || e, sortable: !0, searchable: !0 });
                                                  const r = i[o];
                              ...
                              remove(t) {
                                  Array.isArray(t) || (t = [t]),
                                      ...
                                      this.dt.data.data.forEach((e) => (e.cells = e.cells.filter((e, s) => !t.includes(s)))),
                                      this.dt.update(!0);
                              }
                              filter(t, e = !1) {
                          ...
                          const et = {
                                  ...
                                  template: (t, e) =>
                                      `<div class='${t.classes.top}'>\n    ${
                                          ...
                                          t.searchable
                                              ? `<div class='${t.classes.search}'>\n            <input class='${t.classes.input}' placeholder='${t.labels.placeholder}' type='search' name="search" title='${t.labels.searchTitle}'${
                              ...
                              st = (t, e, s, i = {}) => ({
                                  ...
                                  childNodes: [
                                      {
                                          nodeName: "BUTTON",
                                          attributes: { "data-page": String(t), class: s.classes.paginationListItemLink, "aria-label": s.labels.pageTitle.replace("{page}", String(t)) },
                              ...
                              it = (t, e, s, i, n) => {
                                  ...
                                  let o = [...Array(i).keys()].map((t) => st(t + 1, String(t + 1), n, { active: t === s - 1 }));
                                  if (
                                      (n.truncatePager &&
                                          (o = ((t, e, s, i) => {
                          ...
                          class at {
                              ...
                              init() {
                                  this.initialized ||
                                      (this.options.classes.editable?.split(" ").forEach((t) => this.dt.wrapperDOM.classList.add(t)),
                                      this.options.inline &&
                              ...
                              editCell(t) {
                                  ...
                                  (this.data = { cell: i, rowIndex: s, columnIndex: e, content: n(i) }), (this.editing = !0), (this.editingCell = !0), this.options.inline ? this.dt.update() : this.editCellModal(), this.closeMenu();
                              }
                              editCellModal() {
                                      ...
                                      r.addEventListener("click", (t) => {
                                          ...
                                          e instanceof Element &&
                                              (e.hasAttribute("data-editor-cancel")
                                                  ...
                                                  : e.hasAttribute("data-editor-save") && (t.preventDefault(), this.saveCell(c.value)));
                                      });
                              }
                              saveCell(t) {
                              ...
                              saveRow(t, e) {
                                  ...
                                  if (t) {
                                      ...
                                      i.cells = e.map((e, i) => {
                                          ...
                                          else if ("boolean" === n) o = ["", "false", "0"].includes(a) ? { data: !1, text: "false", order: 0 } : { data: !0, text: "true", order: 1 };
                                          else if ("html" === n) o = { data: [{ nodeName: "#text", data: a }], text: a, order: a };
                              ...
                              rowRender(t, e, s) {
                                  ...
                                  if (this.editingCell) {
                                      ...
                                      ].childNodes = [{ nodeName: "INPUT", attributes: { type: "text", value: this.data.content, class: this.options.classes.input } }];
                                  } else
                                      e.childNodes.forEach((s, i) => {
                                          const n = o(i, this.dt.columns.settings),
                                              r = t[n];
                                          if (!this.options.excludeColumns.includes(n)) {
                                              e.childNodes[i].childNodes = [{ nodeName: "INPUT", attributes: { type: "text", value: a(r.text || String(r.data) || ""), class: this.options.classes.input } }];
                                          }
                                      });
                                  return e;
                              }
                                          ...
                                          html: this.dt.data.headings
                                              .map((t, e) => {
                                                  ...
                                                  return this.options.hiddenColumns.includes(e)
                                                      ? ""
                                                      : `<li data-column="${e}">\n                        <input type="checkbox" value="${t.text || t.data}" ${
                                                            s.hidden ? "" : "checked=''"
                                                        }>\n                        <label>\n                            ${t.text || t.data}\n                        </label>\n                    </li>`;
                                              })
                                              .join(""),
                          ...
                          (exports.DataTable = class {
                              ...
                              constructor(t, e = {}) {
                                  ...
                                  (this.options = { ...et, ...e, diffDomOptions: i, labels: n, classes: a }),
                                      (this._initialHTML = this.options.destroyable ? s.outerHTML : ""),
                                      ...
                                      (this._dd = new j(this.options.diffDomOptions || {})),
                                      (this.initialized = !1),
                                      (this._events = {}),
                                      (this._currentPage = 0),
                                      (this.onFirstPage = !0),
                              ...
                              init() {
                                  ...
                                  (this._virtualDOM = k(this.dom, this.options.diffDomOptions || {})),
                                      ...
                                      (this._tableFooters = this._virtualDOM.childNodes?.filter((t) => "TFOOT" === t.nodeName) ?? []),
                                      (this._tableCaptions = this._virtualDOM.childNodes?.filter((t) => "CAPTION" === t.nodeName) ?? []),
                                      void 0 !== this.options.caption && this._tableCaptions.push({ nodeName: "CAPTION", childNodes: [{ nodeName: "#text", data: this.options.caption }] }),
                                      (this.rows = new K(this)),
                                      (this.columns = new tt(this)),
                                      (this.data = G(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format)),
                                      this._render(),
                                      setTimeout(() => {
                              ...
                              _renderPage(t = !1) {
                                  ...
                                  if (
                                      (this.totalPages &&
                                          ((s = this._currentPage - 1), (i = s * this.options.perPage), (n = i + this.pages[s].length), (i += 1), (e = this._searchQueries.length ? this._searchData.length : this.data.data.length)),
                              ...
                              _renderSeparateHeader() {
                                  ...
                                  let e = {
                                      ...
                                      childNodes: [{ nodeName: "THEAD", childNodes: [F(this.data.headings, this.columns.settings, this.columns._state, this.options, { unhideHeader: !0 })] }],
                                  };
                                          ...
                                          if (
                                              (Array.from(this.wrapperDOM.querySelectorAll(e))
                                                  ...
                                                  .forEach((t) => {
                                                      ...
                                                      e
                                                          ? s.forEach((e) => {
                                                                t.dataset.columns ? i.push({ terms: [e], columns: JSON.parse(t.dataset.columns) }) : i.push({ terms: [e], columns: void 0 });
                                                            })
                                                          : t.dataset.columns
                                                          ? i.push({ terms: s, columns: JSON.parse(t.dataset.columns) })
                              ...
                              update(t = !1) {
                                  t && (this.columns._measureWidths(), (this.hasRows = Boolean(this.data.data.length)), (this.hasHeadings = Boolean(this.data.headings.length))),
                                      this.options.classes.empty?.split(" ").forEach((t) => this.wrapperDOM.classList.remove(t)),
                                      this._paginate(),
                                      this._renderPage(),
                                      this._renderPagers(),
                              ...
                              search(t, e = void 0) {
                                  if (!t.length)
                                      return (this._currentPage = 1), (this._searchQueries = []), (this._searchData = []), this.update(), this.emit("datatable.search", "", []), this.wrapperDOM.classList.remove("search-results"), !1;
                                      ...
                                      e.forEach((e, i) => {
                                          ...
                                          Object.entries(e).forEach(([e, s]) => {
                                              ...
                                              a > -1
                                                  ...
                                                  : this.hasHeadings || this.hasRows || 0 !== i || ((n[t.length] = X(s, this.columns.settings[t.length])), t.push(e), this.data.headings.push(Z(e)));
                                          }),
                                              s.push({ cells: n });
                                      });
                                  } else
                                      t(e) &&
                                          (!e.headings || this.hasHeadings || this.hasRows
                                              ? e.data &&
                                                ...
                                                (s = e.data.map((t) => {
                                                    let e, s;
                                                    return Array.isArray(t) ? ((e = {}), (s = t)) : ((e = t.attributes), (s = t.cells)), { attributes: e, cells: s.map((t, e) => X(t, this.columns.settings[e])) };
                                                }))
                              ...
                              setMessage(t) {
                                  ...
                                  let s = {
                                      ...
                                      attributes: this._tableAttributes,
                                      childNodes: [
                                          { nodeName: "THEAD", childNodes: [F(this.data.headings, this.columns.settings, this.columns._state, this.options, {})] },
                                          {
                                              nodeName: "TBODY",
                                              childNodes: [{ nodeName: "TR", childNodes: [{ nodeName: "TD", attributes: { class: this.options.classes.empty, colspan: String(e) }, childNodes: [{ nodeName: "#text", data: t }] }] }],
                                          },
                                      ],
                                  };
                                  if (
                                      ...
                                      (s.attributes.class = c(s.attributes.class, this.options.classes.table)),
